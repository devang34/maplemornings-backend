...
exports.deleteDiseaseController = exports.addDishesToDiseaseController = exports.getDisease = exports.getAllDiseases = exports.updateDisease = exports.addDisease = void 0;
...
const addDisease = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existingDisease = yield (0, disease_services_1.checkExistingDisease)(name);
        if (existingDisease) {
            res.status(400).json({ error: "Disease name must be unique" });
            return;
        }
        const disease = yield (0, disease_services_1.createDisease)(name, desc, prevention);
...
const updateDisease = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!name && !desc && !prevention) {
            res.status(400).json({
                error: "At least one field (name, desc, or prevention) is required to update",
            });
            return;
        }
        const updatedDisease = yield (0, disease_services_1.updateDiseaseById)(Number(id), {
            name,
            desc,
            prevention,
        });
...
const getAllDiseases = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getDisease = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        console.log(id, "id");
...
const addDishesToDiseaseController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const diseaseExistsOrNot = yield (0, disease_services_1.diseaseExists)(diseaseId);
        if (!diseaseExistsOrNot) {
            res.status(404).json({ error: "Disease not found" });
            return;
        }
        const updatedDisease = yield (0, disease_services_1.addDishesToDisease)(Number(diseaseId), dishIds);
        res.status(200).json({
...
const deleteDiseaseController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
